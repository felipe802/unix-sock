# 📜 **Ensaios Teóricos**
 ...
 | **[`Layers.md`](./Layers.md)** | 🥞 *A Pilha TCP/IP* | A jornada arquitetural do encapsulamento. Disseca a fronteira entre o espaço do usuário (Aplicação) e o trabalho braçal do Kernel/Hardware (Transporte ao Físico). |
 ...
 | **[`IP.md`](./IP.md)** | 🧮 *Endereçamento Lógico* | O tratado matemático sobre o CIDR, o paradoxo do bootstrapping via DHCP e a anatomia da pilha IP no Kernel lidando com o roteamento e IPv6. |
 | **[`TCP.md`](./TCP.md)** | 🛡️ *Estado e Confiabilidade* | A arquitetura rigorosa do controle de fluxo, temporizadores dinâmicos, *Fast Retransmit*, SACK e o abismo do *TIME_WAIT* garantindo a ordem sobre o caos do IP. |
 | **[`UDP.md`](./UDP.md)** | ⚡ *A Velocidade do Caos* | A filosofia minimalista da RFC 768. Disseca a multiplexação via *Sockets*, a absoluta ausência de estado e a genialidade oculta no Princípio Fim-a-Fim. |
